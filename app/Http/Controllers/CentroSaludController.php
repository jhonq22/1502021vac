...
class CentroSaludController extends Controller
{
     ...
     public function centrosaludList()
    {
        ...
        SELECT centro_salud.id, centro_salud, codigo_sicm, estado, municipio,direccion,tipo,contacto_tlf,contacto_email, 
    ...
    {
        $centro_salud = DB::select("SELECT centro_salud.id, codigo_sicm, centro_salud, estado, municipio,direccion,tipo,contacto_tlf,contacto_email, 
        centro_salud.created_at, centro_salud.updated_at
        FROM centro_salud
        LEFT JOIN estados ON estado_id = estados.id
        LEFT JOIN municipios ON municipio_id = municipios.id
